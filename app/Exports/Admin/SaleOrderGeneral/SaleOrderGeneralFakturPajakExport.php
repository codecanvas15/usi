...
class SaleOrderGeneralFakturPajakExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithEvents
{
    public $data;
    public $view;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getCell('A3')->setValue('LAPORAN PENJUALAN GENERAL DENGAN FAKTUR PAJAK')->getStyle()->getFont()->setBold(true);
                ...
                // sub total to array
                $sub_total = array_column($this->data['data']->toArray(), 'sub_total');
                ...
                // ppn to array
                $ppn = array_column($this->data['data']->toArray(), 'total_tax');
