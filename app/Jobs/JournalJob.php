...
class JournalJob implements ShouldQueue
{
    ...
    protected $type;
    protected $model_id;
    public function __construct($type, $model_id)
    {
        $this->type = $type;
     ...
     * @return void
     */
    protected function generate_general_journal()
    {
        DB::beginTransaction();
     ...
     * @return void
     */
    protected function generate_service_journal()
    {
        DB::beginTransaction();
     ...
     * @return void
     */
    protected function generate_trading_journal()
    {
        // // get needed data
        $item_receiving_report = ItemReceivingReport::findOrFail($this->model_id);
     ...
     * @return void
     */
    protected function generate_purchase_transport_journal()
    {
        $item_receiving_report = ItemReceivingReport::findOrFail($this->model_id);
     ...
     * @return void
     */
    protected function generate_invoice_trading_journal()
    {
        // * get needed data
    ...
    public function generate_cash_bond_journal(): void
    {
        ...
        $journal->fill([
            ...
            'reference_model' => \App\Models\CashBond::class,
            'document_reference' => [
                'id' => $cash_bond->id,
    ...
    public function generate_supplier_invoice_journal()
    {
        ...
        foreach ($supplier_invoice->supplier_invoice_down_payments as $key => $supplier_invoice_down_payment) {
            ...
            $supplier_invoice_down_payment->cash_advance_payment->update([
                'returned_amount' => $cash_advance_cash_advance->debit + ($cash_advance_tax->debit ?? 0),
            ]);
        }
