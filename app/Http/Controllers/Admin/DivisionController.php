...
class DivisionController extends Controller
{
     ...
     * @var string
     */
    protected string $view_folder = 'division';
    ...
    public function getEmployeeDivision(Request $request, $division)
    {
        $model = model::find($division);

        $data = \App\Models\Employee::orderByDesc('created_at')->where('division_id', $division)->with(['branch', 'position', 'employment_status'])->select('employees.*');
