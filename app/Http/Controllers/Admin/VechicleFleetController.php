...
use App\Models\VechicleFleet as model;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Yajra\DataTables\Facades\DataTables;

class VechicleFleetController extends Controller
{
    /**
     ...
     * @var string
     */
    protected string $view_folder = 'vehicle-fleet';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route("admin.$this->view_folder.index")->with($this->ResponseMessageCRUD(true));
    }
    ...
    {
        $model = model::orWhere('nama', 'like', "%$request->search%")->paginate(10);

        return $this->ResponseJsonData($model->items());
    }
