...
use App\Models\MasterHrdAssessment as model;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Yajra\DataTables\DataTables;

class MasterHrdAssessmentController extends Controller
{
    /**
     ...
     * @var string
     */
    protected string $view_folder = 'master-hrd-assessment';
    ...
    {
        if ($request->search) {
            $data = model::where('title', 'like', "%{$request->search}%")
                ->limit(10)
