        ...
        <div class="box-body">
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route('admin.purchase-order-service.show', ['purchase_order_service' => $model->id]) }}">{{ Str::headline($title) }}</a>
                    </li>
                    <li class="breadcrumb-item active">
...
@section('content')
    @can('edit purchase-service')
        ...
        <form action="{{ route('admin.purchase-order-service.update', ['purchase_order_service' => $model->id]) }}" enctype="multipart/form-data" id="form-update" method="post">
            @csrf
            @method('put')
        ...
        <script>
            $(document).ready(function() {
                ...
                const getDataPurchaseOrder = () => {
                    $.ajax({
                        type: "post",
                        url: "{{ route('admin.purchase-order-service.data-for-edit', ['id' => $model]) }}",
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
                        success: function({
                ...
                const displayFirstCard = () => {
                    ...
                    const displayCardAndForm = () => {
                        ...
                        let spk_form = '<div class="col-md-3">';
                        if (is_spk) {
                            spk_form += `<x-input-checkbox label="Buat SPK" name="is_spk" id="is_spk" value="1" checked />`
                        } else {
                            spk_form += `<x-input-checkbox label="Buat SPK" name="is_spk" id="is_spk" value="1" />`
                        }

                        spk_form += `</div>
                                        <div class="col-md-12 ${is_spk ? '' : 'd-none'}" id="spk-form">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <x-input type="text" name="pic" id="pic" label="PIC" value="${pic}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>`;
                        ...
                        let html = `<x-card-data-table :title='"edit $main"'>
                                        ...
                                        <x-slot name="table_content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <x-input class="datepicker-input" name="date" label="tanggal" value="${localDate(date)}" id="date-input" onchange="checkClosingPeriod($(this))" required readonly/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <x-input type="text" name="payment_description" label="keterangan pembayaran" value="${payment_description ? payment_description : ''}" />
                                                    </div>
                                                </div>
                                                ${spk_form}
                                                <div class="col-md-4">
                ...
                const displayMainData = () => {
                    ...
                    const displayData = (row_index) => {
                        ...
                        MainDataCalculate[row_index] = {
                            ...
                            "purchase_order_service_detail_id": main_data_lists[row_index].id,
                            "purchase_order_service_detail_item": [],
                        };
                        ...
                        const displayItemForm = () => {
                            ...
                            purchase_order_service_detail_items.map((purchase_order_service_detail_item, purchase_order_service_detail_item_index) => {

                                MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index] = {
                                    "purchase_order_service_detail_item_id": purchase_order_service_detail_item.id,
                                    "purchase_request_detail_id": purchase_order_service_detail_item.purchase_request_detail_id,
                                    "item": purchase_order_service_detail_item.item,
                                    "quantity": purchase_order_service_detail_item.quantity,
                                    "price_before_discount": purchase_order_service_detail_item.price_before_discount,
                                    "discount": purchase_order_service_detail_item.discount,
                                    "price": purchase_order_service_detail_item.price,
                                    "original_price": parentData.is_include_tax ? purchase_order_service_detail_item.price_before_discount - purchase_order_service_detail_item.discount : purchase_order_service_detail_item.price,
                                };

                                let original_price = parentData.is_include_tax ? purchase_order_service_detail_item.price_before_discount - purchase_order_service_detail_item.discount : purchase_order_service_detail_item.price;
                                ...
                                let {
                                    ...
                                    item,
                                    purchase_order_service_detail_item_taxes,
                                } = purchase_order_service_detail_item;

                                TAX_OPTION = purchase_order_service_detail_item_taxes.map((purchase_order_service_detail_item_tax) => {
                                    return `<option value="${purchase_order_service_detail_item_tax.tax.id}" selected>${purchase_order_service_detail_item_tax.tax.name}</option>`
                                }).join('');

                                TAX_LIST_ID = purchase_order_service_detail_item_taxes.map((purchase_order_service_detail_item_tax) => {
                                    return purchase_order_service_detail_item_tax.tax.id
                                });

                                TAX_LIST_VALUE = purchase_order_service_detail_item_taxes.map((purchase_order_service_detail_item_tax) => {
                                    return purchase_order_service_detail_item_tax.tax;
                                });

                                let item_value = purchase_order_service_detail_item.item_id ? purchase_order_service_detail_item.item.nama + " - " + purchase_order_service_detail_item.item.kode : purchase_order_service_detail_item.item;
                                let html = `
                                    <div class="row" id="row-${row_index}-${purchase_order_service_detail_item_index}">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <x-select name="main_item_id[]" label="item" id="main-item-select-${row_index}-${purchase_order_service_detail_item_index}" required disabled>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_unit[]" label="satuan" id="main-item-unit-${row_index}-${purchase_order_service_detail_item_index}" value="${item.unit.name}" required readonly />
                                            </div>
                                        </div>
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_price_before_discount[]" label="harga sebelum diskon" class="commas-form" id="main-item-price-before-discount-${row_index}-${purchase_order_service_detail_item_index}" value="${formatRupiahWithDecimal(price_before_discount)}" required />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_discount[]" label="diskon" class="commas-form" id="main-item-discount-${row_index}-${purchase_order_service_detail_item_index}" value="${formatRupiahWithDecimal(discount)}"  required/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_price[]" label="harga" class="commas-form" id="main-item-price-${row_index}-${purchase_order_service_detail_item_index}" value="${original_price}" required readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_jumlah_diminta[]" label="jumlah diminta" class="commas-form" value="${purchase_request_detail.jumlah_diapprove}" id="main-item-quantityRequested-${row_index}-${purchase_order_service_detail_item_index}" required readonly helpers="${purchase_request_detail.unit.name}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_quantity[]" label="jumlah" class="commas-form main-quantity" id="main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}" value="${quantity}" useCustomError required />
                                            </div>
                                        </div>
                                        <div class="col-md-1 d-flex align-self-center">
                                            <div class="form-group">
                                                <x-button color="info" icon="eye" fontawesome size="sm" id="purchase-requestDetail-btnmodal-${row_index}-${purchase_order_service_detail_item_index}" dataToggle="modal" dataTarget="#modalpurchase-requestDetail-modal-${row_index}-${purchase_order_service_detail_item_index}"/>
                                                <x-button type="" color="danger" icon="trash" fontawesome size="sm" id="purchase-requestDetail-delete-${row_index}-${purchase_order_service_detail_item_index}"/>
                                                <x-modal title="Detail purchase request item" id="modalpurchase-requestDetail-modal-${row_index}-${purchase_order_service_detail_item_index}" headerColor="info" modalSize="1000">
                                                    <x-slot name="modal_body">
                                                        <x-table id="">
                                ...
                                $(`#purchase-requestDetail-btnmodal-${row_index}-${purchase_order_service_detail_item_index}`).click(function(e) {
                                    e.preventDefault();
                                });

                                $(`#purchase-requestDetail-delete-${row_index}-${purchase_order_service_detail_item_index}`).click(function(e) {
                                    e.preventDefault();

                                    $(`#row-${row_index}-${purchase_order_service_detail_item_index}`).remove();
                                    MainDataCalculate[row_index].purchase_order_service_detail_item.splice(purchase_order_service_detail_item_index, 1);
                                    calculateResumeData();
                                });

                                $(`#main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}`).data('testQty', purchase_request_detail.jumlah_diapprove);

                                initCommasForm();
                                eventListenerForm(row_index, purchase_order_service_detail_item_index);
                            })

                        };

                        const eventListenerForm = (row_index, purchase_order_service_detail_item_index) => {

                            initSelect2SearchPaginationData(`main-item-select-${row_index}-${purchase_order_service_detail_item_index}`, `{{ route('admin.select.item-type') }}/service`, {
                                id: 'id',
                                text: 'kode,item'
                            })

                            $(`#main-item-select-${row_index}-${purchase_order_service_detail_item_index}`).change(function(e) {
                                e.preventDefault();
                                ...
                                if (this.value) {
                                    $.ajax({
                                        ...
                                        success: function({
                                            ...
                                            $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).val(decimalFormatterCommasWithOuNumberWithCommas(data.harga_beli));
                                            $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).trigger('keyup');
                                            $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).trigger('blur');
                                        }
                                    });
                                    ...
                                    $.ajax({
                                        ...
                                        success: function({
                                            ...
                                            MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index].item = data;
                                            $(`#main-item-unit-${row_index}-${purchase_order_service_detail_item_index}`).val(data.unit.name);
                                        }
                                    });
                                } else {
                                    $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).val(0);
                                    $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).trigger('keyup');
                                    $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).trigger('blur');
                                }
                            });

                            $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).keyup(function(e) {
                                e.preventDefault();
                                MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index].price = thousandToFloat(this.value);
                                MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index].original_price = thousandToFloat(this.value);
                            })

                            $(`#main-item-price-before-discount-${row_index}-${purchase_order_service_detail_item_index}`).on('blur', function(e) {
                                calculate_final_price(row_index, purchase_order_service_detail_item_index);
                                MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index].price_before_discount = thousandToFloat(this.value);
                            });

                            $(`#main-item-discount-${row_index}-${purchase_order_service_detail_item_index}`).on('blur', function(e) {
                                calculate_final_price(row_index, purchase_order_service_detail_item_index);
                                MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index].discount = thousandToFloat(this.value);
                            });

                            $(`#main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}`).keyup(function(e) {
                                e.preventDefault();

                                let req_qty = $(this).data('testQty');

                                if (thousandToFloat(this.value) > req_qty) {
                                    $(this).addClass('is-invalid');
                                    $(`#error-message-for-main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}`).text('Jumlah tidak boleh lebih dari jumlah diminta!');
                                } else {
                                    $(this).removeClass('is-invalid');
                                    $(`#error-message-for-main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}`).text(null);
                                }

                                MainDataCalculate[row_index].purchase_order_service_detail_item[purchase_order_service_detail_item_index].quantity = thousandToFloat(this.value);
                            })

                            $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).trigger('keyup');
                            $(`#main-item-price-${row_index}-${purchase_order_service_detail_item_index}`).trigger('blur');
                            $(`#main-item-quantityRequested-${row_index}-${purchase_order_service_detail_item_index}`).trigger('blur');
                            $(`#main-item-quantityRequested-${row_index}-${purchase_order_service_detail_item_index}`).trigger('blur');
                            $(`#main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}`).trigger('keyup');
                            $(`#main-item-quantity-${row_index}-${purchase_order_service_detail_item_index}`).trigger('blur');
                        };
                ...
                const displayAdditional = () => {
                    ...
                    const displayAdditionalData = (additional_index) => {
                        ...
                        additionalDataCalculate = {
                            "purchase_order_service_detail_id": additional_data_lists[additional_index].id,
                            "purchase_order_service_detail_items": []
                        };
                        ...
                        const displayAdditionalItemForm = (row_index) => {
                            ...
                            let {
                                ...
                                item,
                                purchase_order_service_detail_item_taxes
                            } = purchase_order_service_detail_items[row_index];

                            additionalDataCalculate.purchase_order_service_detail_items[row_index] = {
                                item: item,
                                quantity: quantity,
                                price: price
                            }

                            TAX_LIST_ADDITIONAL_OPTION = purchase_order_service_detail_item_taxes.map((tax) => {
                                return `<option value="${tax.id}">${tax.name}</option>`;
                            }).join('');

                            TAX_LIST_ADDITIONAL_ID = purchase_order_service_detail_item_taxes.map((tax) => tax.id);
                            TAX_LIST_ADDITIONAL_VALUE = purchase_order_service_detail_item_taxes.map((tax) => tax.value);
                        ...
                        const displayFormData = () => {
                            purchase_order_service_detail_items.map((purchase_order_service_detail_item, purchase_order_service_detail_item_index) => {
                                ...
                                displayAdditionalItemForm(purchase_order_service_detail_item_index);
                            });
                        };
                    ...
                    const handleEventListener = (row_index, purchase_order_service_item = true) => {
                        ...
                        $(`#additional-itemType-select-${row_index}`).change(function(e) {
                            ...
                            if (purchase_order_service_item) {
                            ...
                            purchase_order_service_item = true;
                            ...
                            if (this.value) {
                                    ...
                                    if (this.value) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function({
                                                ...
                                                additionalDataCalculate.purchase_order_service_detail_items[row_index].item = data;
                                ...
                                $(`#additional-item-price-${row_index}`).keyup(function(e) {
                                    additionalDataCalculate.purchase_order_service_detail_items[row_index].price = thousandToFloat($(this).val());
                                });

                                $(`#additional-item-quantity-${row_index}`).keyup(function(e) {
                                    additionalDataCalculate.purchase_order_service_detail_items[row_index].quantity = thousandToFloat($(this).val());
                                });
                            }
                        });
                    ...
                    const removeAdditionalItem = (row_index) => {
                        ...
                        additionalDataCalculate.purchase_order_service_detail_items[row_index] = null;
                    };
                    ...
                    const display = () => {
                        ...
                        if (additional_data_lists.length > 0) {
                            ...
                            additionalItemsCount = 0;
                            additionalDataCalculate.purchase_order_service_detail_items = []
                ...
                const calculateResumeData = () => {
                    ...
                    const calculateMain = () => {
                        ...
                        MainDataCalculate.map((main_data, main_data_index) => {
                            ...
                            main_data.purchase_order_service_detail_item.map((main_data_item, main_data_item_index) => {
                                ...
                                if ($('#is_include_tax').is(':checked')) {
                                    ...
                                    MainDataCalculate[main_data_index].purchase_order_service_detail_item[main_data_item_index].price = price;
                                } else {
                                    price = original_price;
                                    MainDataCalculate[main_data_index].purchase_order_service_detail_item[main_data_item_index].price = original_price;
                                }
                    ...
                    const calculateAdditional = () => {
                        ...
                        additionalDataCalculate.purchase_order_service_detail_items.map((additional, additional_data) => {
                            ...
                            let values = {
                                ...
                                main: MainDataCalculate.map((main, main_index) => {
                                    return {
                                        ...
                                        "purchase_order_service_detail_id": main.purchase_order_service_detail_id,
                                        "purchase_order_service_detail_items": main.purchase_order_service_detail_item.map((main_data_item, main_data_index) => {
                                            return {
                                                "purchase_order_service_detail_item_id": main_data_item.purchase_order_service_detail_item_id,
                                ...
                                additional: {
                                    "purchase_order_service_detail_id": additionalDataCalculate.purchase_order_service_detail_id,
                                    "purchase_order_service_detail_items": additionalDataCalculate.purchase_order_service_detail_items.map((additional, additional_index) => {
                                        if (additional != null) {
                                            return {
