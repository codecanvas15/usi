...
<head>
    ...
    <title>Purchase Order Service - {{ $model->code }}</title>
    <style>
        body {
            ...
            <tr>
                <td class="p-0 valign-top">
                    <table>
                        <tbody>
                            <tr>
                                <td class="p-0 valign-top" width="30%">No. PR</td>
                                <td class="p-0 valign-top" width="5%">:</td>
                                <td class="p-0 valign-top">{{ implode(', ', $purchase_request_code) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="p-0 valign-top">Pembayaran</td>
                                <td class="p-0 valign-top">:</td>
                                <td class="p-0 valign-top text-uppercase">{{ $model->term_of_payment == 'cash' ? 'cash' : $model->term_of_payment_days . ' hari' }}</td>
                            </tr>
                            <tr>
                ...
                <td class="p-0 valign-top">
                    <table>
                        <tbody>
                            <tr>
                                <td class="p-0 valign-top" width="25%">Kepada YTH</td>
                                <td class="p-0 valign-top" width="5%">:</td>
                                <td class="p-0 valign-top">{{ $model->vendor->nama }}</td>
                            </tr>
                            <tr>
                                <td class="p-0 valign-top">Alamat</td>
                                <td class="p-0 valign-top">:</td>
                                <td class="p-0 valign-top">{{ $model->vendor->alamat }}</td>
                            </tr>
                            <tr>
                                <td class="p-0 valign-top">Telepon</td>
                                <td class="p-0 valign-top">:</td>
                                <td class="p-0 valign-top">{{ $model->vendor->business_phone }}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                ...
                @foreach ($model->purchaseOrderServiceDetails()->get() as $key => $purchaseOrderServiceDetail)
                    @foreach ($purchaseOrderServiceDetail->purchase_order_service_detail_items as $purchase_order_service_detail_item)
                        <tr>
                            ...
                            <td class="text-end">{{ formatNumber($purchase_order_service_detail_item->quantity) }} {{ $purchase_order_service_detail_item->unit?->name }}</td>
