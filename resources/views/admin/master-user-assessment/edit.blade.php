                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-input type="text" name="name" value="{{ $model->name }}" label="Nama" id="name" required />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-input type="number" name="weight" value="{{ $model->weight * 100 }}" label="Bobot (persentase)" id="weight" required />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-select name="type" label="Tipe" id="type" required>
                                    <option value="key behavioral competencies" @if ($model->type == 'key behavioral competencies') selected @endif>Key Behavioral Competencies</option>
                                    <option value="key skill competencies" @if ($model->type == 'key skill competencies') selected @endif>Key Skill Competencies</option>
                                </x-select>
                            </div>
                        </div>
                    </div>
