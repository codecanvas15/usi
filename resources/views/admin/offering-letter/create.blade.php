            ...
            <x-card-data-table title="tambah {{ $title }}">
                ...
                <x-slot name="table_content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-input type="text" id="reference" label="kode" name="reference" value="{{ generate_code(\App\Models\OfferingLetter::class, 'reference', 'created_at', 'HRDOL', branch_sort: get_current_branch()->sort ?? null, date: \Carbon\Carbon::now()->format('d-m-Y')) }}" readonly />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-select name="labor_application_id" label="lamaran" id="laborApplication" hasError errorBorderId="errorSelectLaborApplication" errorMessageId="errorMsgLaborApplication" errorMsg="Lamaran wajib dipilih." required></x-select>
                            </div>
                        </div>
                    </div>
                    <div class="row border-primary border-top pt-20 mt-10 mb-10">
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" label="nama" id="employeeName" readonly></x-input>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" label="tempat / tgl. lahir" id="pob" readonly></x-input>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" label="alamat" id="address" readonly></x-input>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" label="jabatan" id="position" readonly></x-input>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" label="departemen" id="division" readonly></x-input>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" label="tempat penerimaan" id="workPlacement" readonly></x-input>
                            </div>
                        </div>
                    </div>
                    <div class="row border-primary border-top mt-10 pt-20">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" name="nik" label="NIK" id="nik" useCustomError required></x-input>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" class="commas-form" name="salary" label="gaji" id="salary" useCustomError required></x-input>
                            </div>
                        </div>
                        <div class="col-md-3 d-flex align-self-center">
                            <div class="form-group">
                                <x-button type="button" color="info" label="generate" soft icon="rotate" fontawesome size="sm" id="generate-button" />
                            </div>
                        </div>
                    </div>
                    <div class="row content-generated mt-20">
                        <div class="col">
                            ...
                            <textarea name="offering_letter" id="content-generated-textarea" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </x-slot>
                <x-slot name="footer">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            checkClosingPeriod($('#startWorkDate'))
            ...
            const initSelect2LaborApplication = () => {
                let opts = {
                    ...
                    ajax: {
                        url: `${base_url}/select/labor-application?status=approve`,
                        dataType: "json",
                        delay: 250,
                        type: "get",
                        data: ({
            ...
            $('#nik').keyup(debounce(function() {
                ...
                if ($(this).val() == '') {
                    $('#nik').addClass('is-invalid');
                    $('#error-message-for-nik').text('NIK wajib diisi.');
                } else {
