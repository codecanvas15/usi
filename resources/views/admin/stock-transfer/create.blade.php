        ...
        <x-card-data-table title="{{ 'create ' . $main }}">
            ...
            <x-slot name="table_content">
                ...
                <form action="{{ route("admin.$main.store") }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input class="datepicker-input" id="date" name="date" label="Tanggal" value="{{ \Carbon\Carbon::now()->format('d-m-Y') }}" required autofucus onchange="checkClosingPeriod($(this))" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <x-select name="from" id="from" label="Gudang" onchange="" required></x-select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <x-select name="to" id="to" label="Ke" required></x-select>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="note" class="form-label">Catatan</label>
                                <textarea type="text" rows="5" class="form-control" name="note" id="note" placeholder="Masukkan Catatan" required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <x-button type="submit" color="primary" label="Save data" id="save-data" />
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const deleteItem = (index) => {
                ...
                conditionIfItemInUse()
            };

            const conditionIfItemInUse = () => {
