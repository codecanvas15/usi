...
<body>
    ...
    <div class="mt-2">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @include('admin.finance-report.summary-uang-muka-pembelian.table.body', ['number_format' => true])
            </tbody>
            <tfoot>
                @include('admin.finance-report.summary-uang-muka-pembelian.table.footer', ['number_format' => true])
            </tfoot>
        </table>
    </div>
</body>
