        ...
        <table class="table table-bordered table-striped mt-10">
            <thead>
                <tr>
                    ...
                    <th class="font-small-1 text-center">KODE SUPPLIER</th>
                    <th class="font-small-1 text-center">NAMA SUPPLIER</th>
            ...
            <tbody>
                @forelse ($data as $key => $d)
                    <tr>
                        ...
                        <td class="font-small-1">{{ $d->vendor_code }}</td>
                        <td class="font-small-1">{{ $d->vendor_nama }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="font-small-1 text-center" colspan="9">TOTAL</th>
