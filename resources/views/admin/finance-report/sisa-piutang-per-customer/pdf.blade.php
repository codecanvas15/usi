        ...
        <table class="table table-bordered table-striped mt-10">
            ...
            <tbody>
                @forelse ($data as $key => $d)
                    <tr>
                        <td></td>
                        <td class="text-left font-small-1"><b>{{ $d->customer_nama }}</b></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    @forelse ($d->data as $key2 => $data)
                        <tr>
                            ...
                            <td class="font-small-1">
                                @php
                                    $modelClass = class_basename($data->model_reference);
                                    $modelMap = [
                                ...
                                @if ($routeName && Route::has($routeName))
                                    <a href="{{ route($routeName, $data->reference_id) }}" target="_blank">
                                        {{ $data->code }}
                                    </a>
                                @else
                                    {{ $data->code }}
