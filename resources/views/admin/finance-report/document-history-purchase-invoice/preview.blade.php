...
@php
    $title = 'histori dokumen purchase invoice';
@endphp
        ...
        <div class="box-body">
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0)">{{ Str::headline($title) }}</a>
                    </li>
                    <li class="breadcrumb-item">
    ...
    <x-card-data-table>
        <x-slot name="header_content">
            <div class="text-center">
                <h3 class="text-uppercase">{{ Str::headline('histori dokumen purchase invoice') }}</h3>
