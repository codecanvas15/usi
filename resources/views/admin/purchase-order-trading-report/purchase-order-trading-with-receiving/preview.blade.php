        ...
        <x-slot name="table_content">
            <x-table theadColor="white" class="table-bordered mt-20">
                <x-slot name="table_head">
                    @include('admin.purchase-order-trading-report.purchase-order-trading-with-receiving.table.header')
                </x-slot>
                <x-slot name="table_body">
                    @include('admin.purchase-order-trading-report.purchase-order-trading-with-receiving.table.body', [
                        'formatNumber' => true,
                    ])
                </x-slot>
                <x-slot name="table_foot">
                    @include('admin.purchase-order-trading-report.purchase-order-trading-with-receiving.table.footer', [
                        'formatNumber' => true,
                    ])
                </x-slot>
            </x-table>
