            ...
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route("admin.$main.index") }}">{{ Str::headline('divisi') }}</a>
                    </li>
                    <li class="breadcrumb-item active">
                        {{ Str::headline('Detail divisi') }}
                    </li>
                </ol>
            </nav>
        </div>
...
@section('content')
    @can("view $main")
        <x-card-data-table title="{{ 'detail divisi' }}">
...
@section('js')
            ...
            $(document).ready(() => {
                ...
                const initTable = () => {
                    const table = $('table#employee-table').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: '{{ route('admin.division.employee', $model) }}',
                        },
                        columns: [{
                                data: 'DT_RowIndex',
                                name: 'DT_RowIndex',
    ...
    <script>
        ...
        sidebarActive('#division-sidebar');
    </script>
@endsection
