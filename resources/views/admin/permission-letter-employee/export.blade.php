...
<body>
    ...
    <table>
        <tr>
            <td class="font-small-1 pb-1" colspan="5">
                Saya yang bertanda tangan dibawah ini :
            </td>
        </tr>
        <tr>
            <td class="font-small-1" width="20%">
                Nama
            </td>
            <td class="font-small-1" colspan="4">
                : {{ $model->employee->name }}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="font-small-1 text-uppercase" colspan="4">
                : {{ $model->employee->position->nama }}
            </td>
        </tr>
        <tr>
            <td colspan="5" class="pb-1"></td>
        </tr>
        @php
        ...
        @endphp
        <tr>
            <td class="font-small-1" colspan="2">
                Bermaksud melaporkan bahwa hari ini
            </td>
            <td class="font-small-1 border-bottom">
        ...
        <tr>
            <td class="font-small-1 p-0" colspan="2">
                <table>
                    <tr>
                        ...
                        <td class="text-end font-small-2">Jam &nbsp;&nbsp;</td>
                    </tr>
                </table>
            </td>
            <td class="font-small-2 border-bottom valign-middle" colspan="3">
                : {{ $model->letter_type == 'came too late' ? Carbon\Carbon::parse($model->letter_date_start)->translatedFormat('H:i') : '' }}
            </td>
        </tr>
        <tr>
            <td class="font-small-2 p-0" colspan="2">
                <table>
                    <tr>
                        <td width="10%">
                        </td>
            ...
            <td class="font-small-2 border-bottom" colspan="3">
        ...
        <tr>
            <td colspan="5" class="pt-2 font-small-2">
