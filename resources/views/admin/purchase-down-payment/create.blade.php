        ...
        <x-card-data-table title="{{ 'Create ' . $main }}">
            ...
            <x-slot name="table_content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-select name="vendor_id" label="vendor" id="vendor_id" required autofocus></x-select>
                        </div>
                    </div>
                </div>
                <div class="row mt-20">
                ...
                <div class="row mt-20">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="mb-2" for="purchase_id">Purchase Order <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-input type="text" name="total_po" id="total_po" class="commas-form text-end total_po" readonly value="0" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-input type="text" name="outstanding_amount" id="outstanding_amount" label="sisa PO" class="commas-form text-end outstanding_amount" readonly value="0" />
                        </div>
                    </div>
                ...
                <table class="table ">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <x-input type="text" name="total_amount" label="total_amount" id="total_amount" required class="commas-form text-end total_po" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="text-end"></td>
                            <td>
                                <x-input type="text" name="subtotal" label="subtotal" id="subtotal" required class="commas-form text-end" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td class="text-end"></td>
