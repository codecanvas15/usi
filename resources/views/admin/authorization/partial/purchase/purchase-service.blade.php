<x-table id="purchase-service-table">
    ...
    <script>
        $(document).ready(function() {
            ...
            const initPurchaseGeneralTable = () => {
                const table = $('table#purchase-service-table').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    destroy: true,
                    ajax: {
                        ...
                        data: {
                            _token: '{{ csrf_token() }}',
                            model: "\\App\\Models\\PurchaseOrderService",
                        },
                    },
                    order: [
                        [7, 'desc']
            ...
            $('#purchase-service-btn').click(function(e) {
                e.preventDefault();
