<x-table id="purchase-general-table">
    ...
    <script>
        $(document).ready(function() {
            ...
            const initPurchaseGeneralTable = () => {
                const table = $('table#purchase-general-table').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    destroy: true,
                    ajax: {
                        ...
                        data: {
                            _token: '{{ csrf_token() }}',
                            model: "\\App\\Models\\PurchaseOrderGeneral",
                        },
                    },
                    order: [
                        [7, 'desc']
            ...
            $('#purchase-general-btn').click(function(e) {
                e.preventDefault();
