<x-table id="purchase-transport-table">
    ...
    <script>
        $(document).ready(function() {
            ...
            const initPurchaseGeneralTable = () => {
                const table = $('table#purchase-transport-table').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    destroy: true,
                    ajax: {
                        ...
                        data: {
                            _token: '{{ csrf_token() }}',
                            model: "\\App\\Models\\PurchaseTransport",
                        },
                    },
                    order: [
                        [7, 'desc']
            ...
            $('#purchase-transport-btn').click(function(e) {
                e.preventDefault();
