                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input class="datepicker-input" id="last_journal_date" name="last_journal_date" class="datepicker-input" label="tanggal terakhir depresiasi" readonly value="" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" id="last_book_value" name="last_book_value" label="nilai akhir aset" value="" readonly required class="commas-form text-end" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" id="date" name="date" label="tanggal" onchange="checkClosingPeriod($(this));calculate_due_date()" required class="datepicker-input" value="{{ date('d-m-Y') }}" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="number" id="due" name="due" label="tempo" required onblur="calculate_due_date()" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input type="text" id="due_date" name="due_date" label="jatuh tempo" required readonly />
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <x-input type="text" id="location" name="location" label="lokasi" required />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col pt-40">
                            <div class="form-group">
                                <input type="checkbox" id="is_selling_asset" name="is_selling_asset" class="filled-in chk-col-primary" onclick="$('#form-selling-asset').toggleClass('d-none');show_selling_form($(this))" value="1">
                                <label for="is_selling_asset">Penjualan Asset</label>
                            </div>
                            <div id="form-selling-asset" class="d-none">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <x-input type="text" id="selling_price" name="selling_price" label="harga jual" class="text-end commas-form" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <x-input type="text" id="tax_number" name="tax_number" label="faktur pajak" class="tax-reference-mask" />
                                        </div>
                                    </div>
                                </div>
                            </div>
