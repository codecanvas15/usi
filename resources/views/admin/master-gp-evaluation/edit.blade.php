                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-input type="text" name="type" value="" label="Tipe" id="type" value="{{ ucwords($model->type) }}" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-text-area name="description" value="" label="Deskripsi" id="description" required>{{ $model->description }}</x-text-area>
                            </div>
                        </div>
                    </div>
                </x-slot>
