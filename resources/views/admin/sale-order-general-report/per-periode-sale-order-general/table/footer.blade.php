<tr>
    ...
    <td class="text-end text-right">{{ $formatNumber ? formatNumber($total->previous_year_total) : $total->previous_year_total }}</td>
    <td class="text-end text-right">{{ $formatNumber ? formatNumber($total->previous_year_total_tax) : $total->previous_year_total_tax }}</td>
    ...
    <td class="text-end text-right">{{ $formatNumber ? formatNumber($total->selected_month_total) : $total->selected_month_total }}</td>
    <td class="text-end text-right">{{ $formatNumber ? formatNumber($total->selected_month_total_tax) : $total->selected_month_total_tax }}</td>
    ...
    <td class="text-end text-right">{{ $formatNumber ? formatNumber($total->january_to_selected_month_total) : $total->january_to_selected_month_total }}</td>
    <td class="text-end text-right">{{ $formatNumber ? formatNumber($total->january_to_selected_month_total_tax) : $total->january_to_selected_month_total_tax }}</td>
