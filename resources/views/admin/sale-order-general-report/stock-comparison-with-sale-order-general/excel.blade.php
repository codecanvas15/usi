...
<table theadColor="white" class="table-bordered mt-20">
    <thead>
        @include('admin.sale-order-general-report.stock-comparison-with-sale-order-general.table.header')
    </thead>
    <tbody>
        @include('admin.sale-order-general-report.stock-comparison-with-sale-order-general.table.body', [
            'formatNumber' => false,
        ])
    </tbody>
    <tfoot>
        @include('admin.sale-order-general-report.stock-comparison-with-sale-order-general.table.footer', [
            'formatNumber' => false,
        ])
    </tfoot>
</table>
