    ...
    <div class="mt-2">
        ...
        <x-table theadColor="white" class="table-bordered mt-20">
            <x-slot name="table_head">
                @include('admin.sale-order-general-report.sale-order-general-faktur-pajak.table.header')
            </x-slot>
            <x-slot name="table_body">
                @include('admin.sale-order-general-report.sale-order-general-faktur-pajak.table.body')
            </x-slot>
            <x-slot name="table_foot">
                @include('admin.sale-order-general-report.sale-order-general-faktur-pajak.table.footer')
            </x-slot>
        </x-table>
        <br>
    </div>
