            ...
            <x-slot name="table_content">
                ...
                <form action="{{ route("admin.$main.store") }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input class="datepicker-input" name="from_date" value="{{ $model ? $model?->from_date : '' ?? \Carbon\Carbon::now()->format('d-m-Y') }}" label="dari tanggal" id="from_date" required onblur="checkDate()" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <x-input class="datepicker-input" name="to_date" value="{{ $model ? $model?->to_date : '' ?? \Carbon\Carbon::now()->format('d-m-Y') }}" label="sampai tanggal" id="to_date" required onblur="checkDate()" />
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        ...
        var selected_employee_ids = JSON.parse('{{ $employee_ids }}');
