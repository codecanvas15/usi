    ...
    <div class="mt-2">
        ...
        <x-table theadColor="white" class="table-bordered mt-20">
            <x-slot name="table_head">
                @include('admin.sale-order-trading-report.summary-sale-order-trading.table.header')
            </x-slot>
            <x-slot name="table_body">
                @include('admin.sale-order-trading-report.summary-sale-order-trading.table.body', [
                    'formatNumber' => true,
                ])
            </x-slot>
            <x-slot name="table_foot">
                @include('admin.sale-order-trading-report.summary-sale-order-trading.table.footer', [
                    'formatNumber' => true,
                ])
            </x-slot>
        </x-table>
