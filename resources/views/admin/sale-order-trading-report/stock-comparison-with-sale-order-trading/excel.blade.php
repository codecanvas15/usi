...
<table theadColor="white" class="table-bordered mt-20">
    <thead>
        @include('admin.sale-order-trading-report.stock-comparison-with-sale-order-trading.table.header')
    </thead>
    <tbody>
        @include('admin.sale-order-trading-report.stock-comparison-with-sale-order-trading.table.body', [
            'formatNumber' => false,
        ])
    </tbody>
    <tfoot>
        @include('admin.sale-order-trading-report.stock-comparison-with-sale-order-trading.table.footer', [
            'formatNumber' => false,
        ])
    </tfoot>
</table>
