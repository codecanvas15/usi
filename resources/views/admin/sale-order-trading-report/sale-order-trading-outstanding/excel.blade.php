...
<table theadColor="white" class="table-bordered mt-20">
    <thead>
        @include('admin.sale-order-trading-report.sale-order-trading-outstanding.table.header')
    </thead>
    <tbody>
        @include('admin.sale-order-trading-report.sale-order-trading-outstanding.table.body', [
            'formatNumber' => false,
        ])
    </tbody>
    <tfoot>
        @include('admin.sale-order-trading-report.sale-order-trading-outstanding.table.footer', [
            'formatNumber' => false,
        ])
    </tfoot>
</table>
