    ...
    <div class="mt-2">
        <div class="row">
            <div class="text-center">
                <h5 class="text-uppercase my-0 font-small-2">laporan {{ Str::headline($type) }}</h5>
        ...
        <x-table theadColor="white" class="table-bordered mt-20">
            <x-slot name="table_head">
                @include('admin.sale-order-trading-report.trading-sales-detail-additional.table.header')
            </x-slot>
            <x-slot name="table_body">
                @include('admin.sale-order-trading-report.trading-sales-detail-additional.table.body', [
                    'formatNumber' => true,
                ])
            </x-slot>
            <x-slot name="table_foot">
                @include('admin.sale-order-trading-report.trading-sales-detail-additional.table.footer', [
                    'formatNumber' => true,
                ])
            </x-slot>
        </x-table>
