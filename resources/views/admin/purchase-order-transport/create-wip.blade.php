        ...
        <script>
            $(document).ready(function() {
                ...
                function initSendForm() {
                    if ($('#send-from').val() == "from_purchase_order") {
                        $('#send-from-result').html(`<div class="col-md-3">
                                            <x-select name="po_trading_id" id="purchase_trading_id" label="PO Trading" required>
                                            </x-select>
                                        </div>`);
                ...
                const initToClient = () => {
                    $('#reference-form').html(`<div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <x-select name="send_form" label="kirim dari" id="send-from" required onchange="initSendForm()" class="form-select">
                                        <option value="">-- pilih --</option>
                            ...
                            <div class="col">
                                <div class="row" id="send-from-result">
