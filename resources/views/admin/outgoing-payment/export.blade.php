...
<head>
    ...
    <title>Kas Keluar {{ $model->nomor_so }}</title>
    <style>
        body {
    ...
    <div class="container" style="color: black">
        <div class="row" style="max-width: 100%; margin-bottom: 5px">
            <div class="text-center">
                <h3 style="margin-bottom: 0px">BUKTI {{ ($model->coa->bank_internal->type ?? '') == 'bank' ? 'BANK' : 'KAS' }} KELUAR</h3>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="valign-top small-font">:</td>
                                    <td class="valign-top small-font">
                                        {{ isset($model->fund_submission->is_giro) ? localDate($model->fund_submission->send_payment->due_date) : '' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="valign-top small-font">
        ...
        <div class="row">
            <table class="table table-bordered">
                ...
                @foreach ($model->outgoing_payment_details ?? [] as $outgoing_payment_detail)
                    <tr>
                        <td class="small-font text-center">{{ $outgoing_payment_detail->coa->account_code }}</th>
                        <td class="small-font text-center">{{ '' }}</td>
                        <td class="small-font text-center">{{ '' }}</td>
                        <td class="small-font">{{ $outgoing_payment_detail->note }}</td>
                        <td class="small-font text-center">{{ '' }}</td>
                        @if (!$model->currency->is_local)
                                ...
                                <table class="border-0">
                                    <tbody>
                                        <tr class="border-0">
                                            ...
                                            <td class="border-0 text-right">{{ formatNumber($outgoing_payment_detail->debit, true) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                            ...
                            <table class="border-0">
                                <tbody>
                                    <tr class="border-0">
                                        ...
                                        <td class="border-0 text-right">{{ formatNumber($outgoing_payment_detail->debit_local, true) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        ...
                        <td class="small-font p-0">
                            <table class="border-0">
                                <tbody>
                                    <tr class="border-0">
                                        <td class="border-0"> {{ $model->currency->simbol }}</td>
                                        <td class="border-0 text-right">{{ formatNumber($model->debit_total, true) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                    ...
                    <td class="small-font p-0">
                        <table class="border-0">
                            <tbody>
                                <tr class="border-0">
                                    <td class="border-0"> {{ get_local_currency()->simbol }}</td>
                                    <td class="border-0 text-right">{{ formatNumber($model->local_debit_total, true) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
            ...
            <p class="small-font">
                <b>Terbilang : </b> {{ strtoupper(Terbilang::make($model->local_debit_total)) }} {{ strtoupper(get_local_currency()->nama) }}
            </p>
        </div>
