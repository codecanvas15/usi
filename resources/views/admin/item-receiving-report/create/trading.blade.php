...
@section('content')
    @can('create item-receiving-report-trading')
        <form action="{{ route("admin.$main.store") }}" method="post" id="form-lpb" enctype="multipart/form-data">
            @csrf
            ...
            <x-card-data-table title="{{ $title }}">
                <x-slot name="table_content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-input type="text" name="customer" id="customer_name" label="customer" required readonly />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-input type="text" name="loading_order" id="loading_order" label="loading_order" required />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                    ...
                    <div class="row border-bottom border-primary">
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-input type="text" name="sale_confirmation" id="sale-confirmation" label="SCO Supplier" helpers="sale confirmation dari purchase order" required />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
        ...
        <script>
            $(document).ready(function() {
                ...
                const handleFormPurchaseTrading = () => {
                    $('#purchase_order_trading_id').change(function(e) {
                        ...
                        if (this.value) {
                            $.ajax({
                                type: "get",
                                url: `{{ route('admin.purchase-order.detail') }}/${$(this).val()}`,
                                success: function({
                                    data
                                }) {
                ...
                const displayItem = () => {
                    ...
                    let unit = purchase_order_data.unit ?? '';
                    ...
                    let html = `
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <x-input type="text" name="jumlah" id="jumlah" label="quantity" value="${formatRupiahWithDecimal(jumlah)} - ${unit}" required readonly />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
