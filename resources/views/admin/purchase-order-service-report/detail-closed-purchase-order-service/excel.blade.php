<table>
    ...
    <tr>
        <td colspan="9" align="center">
            <p><b>PERIODE : {{ localDate($from_date) }} - {{ localDate($to_date) }}</b></p>
        </td>
    </tr>
</table>
...
<table theadColor="white" class="table-bordered mt-20">
    <thead>
        @include('admin.purchase-order-service-report.detail-closed-purchase-order-service.table.header')
    </thead>
    <tbody>
        @include('admin.purchase-order-service-report.detail-closed-purchase-order-service.table.body', [
            'formatNumber' => false,
        ])
    </tbody>
</table>
