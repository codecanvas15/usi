...
@section('content')
    @can("create $main")
        <form id="form-data" action="{{ route("admin.$main.store") }}" method="post">
            @csrf
            <x-card-data-table title="{{ 'Tambah Penggajian' }}">
                ...
                <x-slot name="table_content">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="period" id="period" class="form-control select2" onchange="getPeriodDetail(this)">
                                    ...
                                    @foreach ($periods as $period)
                                        ...
                                        @endphp
                                        <option value="{{ $period->id }}" @if (old('period') == $period->id) selected @endif>[{{ ucwords($period->type) }}] {{ $periodDate }}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="period_type" id="periodType">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Pegawai</label>
                                <select class="form-control select2" id="user" name="user" onchange="setPegawai(this)">
                                    <option value="" selected>-- pilih pegawai --</option>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" @if (old('user') == $user->id) selected @endif>{{ ucwords($user->name) }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row mt-20">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Gaji Take Home Pay <span id="spanBaseSalary"></span></label>
                                <input class="form-control commas-form" id="baseSalary" name="base_salary" value="0" placeholder="Masukkan gaji take home pay" onkeyup="handleOnChangeAmountInput()" onblur="calculateIncomeTax();">
                                <small class="text-danger error_base_salary" style="display: none">THP belum diisi.</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Jumlah Hari Kerja</label>
                                <input class="form-control" id="workDaysTotal" name="work_days_total" value="0" placeholder="Masukkan jumlah hari kerja..." onkeyup="handleOnChangeAmountInput()">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="workDays" name="work_days" value="0" placeholder="Masukkan jumlah masuk kerja..." onkeyup="handleOnChangeAmountInput()">
                    ...
                    <div class="row mb-10">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="alphaDays" name="alpha_days" value="0" readonly>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="absenceDays" name="absences_days" value="0" readonly>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label>Jumlah Cuti</label>
                                <input class="form-control" id="leaveDays" name="leave_days" value="0" readonly>
                            </div>
                        </div>
                    </div>
                </x-slot>
            ...
            <div id="btn-submit">
                <div class="d-flex justify-content-end gap-3">
                    <x-button type="submit" class="btn-save" color="primary" icon="save" size="sm" label="Save data" />
                </div>
            </div>
        </form>
    @endcan
...
@section('js')
    @can("create $main")
        ...
        <script>
            ...
            function getPeriodDetail(e) {
                $('#period').val($(e).val());
                let id = $(e).val();
                $.ajax({
                    url: `/payroll-period-detail/${id}`,
                    method: "GET",
                    success: function(res) {
                        $('#periodType').val(res.data.type);
                        if (res.data.type == "mingguan") {
                            $('#spanBaseSalary').html('(Harian)')
                            $('#workDaysTotal').val(5);
                            $('#workDays').val(0);
                        } else {
                            $('#spanBaseSalary').html('(Bulanan)')
                            $('#workDaysTotal').val(25);
                            $('#workDays').val(0);
                        }
