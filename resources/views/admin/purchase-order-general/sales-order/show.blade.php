    ...
    @can('view purchase-general')
        ...
        <div class="row">
            <div class="col-md-9">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        @foreach ($projects ?? [] as $project)
                                            <p><a href="{{ route('admin.project.show', $project) }}">{{ $project->name }}</a></p>
                                        @endforeach
                                    </div>
                                </div>
                            @endif
                ...
                <x-card-data-table title="Detail purcase order general">
                    <x-slot name="header_content">
                                                    ...
                                                    <x-slot name="modal_body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="">{{ Str::headline('kode') }}</label>
                                                                    <p>{{ $purchaseOrderGeneralDetail->sale_order_general->kode }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="">{{ Str::headline('tanggal') }}</label>
                                                                    <p>{{ $purchaseOrderGeneralDetail->sale_order_general->tanggal }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p>{{ $purchaseOrderGeneralDetail->sale_order_general->customer?->nama }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p>{{ $purchaseOrderGeneralDetail->sale_order_general->created_by_user?->email }}
                                                                        -
                                                                        {{ $purchaseOrderGeneralDetail->sale_order_general->created_by_user?->name }}
                                                                    </p>
                                                                </div>
                                                            </div>
