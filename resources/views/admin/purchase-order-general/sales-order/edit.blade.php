            ...
            $(document).ready(function() {
                ...
                const displayMainData = () => {
                    ...
                    const displayData = (row_index) => {
                        ...
                        MainDataCalculate[row_index] = {
                            "sale_order_id": sale_order_general.id,
                        ...
                        const displayCard = () => {
                            ...
                            let html = `<x-card-data-table id="sale-order-general-card-${row_index}">
                                            <x-slot name="table_content">

                                                <x-modal title="detail sale order item" id="modalPurchaseRequestDetail-${row_index}" headerColor="info" modalSize="800">
                                                    <x-slot name="modal_body">
                                                        <div class="row mb-30">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label">{{ Str::headline('tanggal') }}</label>
                                                                    <p id="sales-order-general-parent-date-${row_index}">${tanggal}</p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label">{{ Str::headline('kode') }}</label>
                                                                    <p id="sales-order-general-parent-code-${row_index}">${kode}</p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label">{{ Str::headline('customer') }}</label>
                                                                    <p id="sales-order-general-parent-customer-${row_index}">${customer.nama}</p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label">{{ Str::headline('cabang') }}</label>
                                                                    <p id="sales-order-general-parent-branch-${row_index}">${branch.name}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </x-slot>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <x-select name="sale_order_id[]" label="sale order" id="purchaseRequest-select-${row_index}" required disabled>
                                                                <option value="${sale_order_general.id}">${kode} - ${tanggal}</option>
                                                            </x-select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 d-flex align-self-end">
                                                        <div class="form-group">
                                                            <x-button color="info" id="btn-purchaseRequest-modal-${row_index}" label="detail sale order" icon="plus" fontawesome size="sm" dataToggle="modal" dataTarget="#modalPurchaseRequestDetail-${row_index}" />
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="mt-10 pt-10 border-top border-primary" id="sale-order-general-detail-list-${row_index}">
                        ...
                        const displayItemForm = () => {
                            ...
                            $(`#sale-order-general-detail-list-${row_index}`).html('');
                            purchase_order_general_detail_items.map((purchase_order_general_detail_item, purchase_order_general_detail_item_index) => {
                                ...
                                MainDataCalculate[row_index].purchase_order_general_detail_item[purchase_order_general_detail_item_index] = {
                                    ...
                                    "sale_order_general_detail_id": purchase_order_general_detail_item.sale_order_general_detail_id,
                                ...
                                let html = `
                                    <div class="row" id="row-${row_index}-${purchase_order_general_detail_item_index}">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <x-select name="main_item_id[]" label="item" id="main-item-select-${row_index}-${purchase_order_general_detail_item_index}" required disabled>
                                                    <option value="${item.id}" selected>${item.kode} - ${item.nama} hahha</option>
                                                </x-select>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_price[]" label="harga" class="commas-form" id="main-item-price-${row_index}-${purchase_order_general_detail_item_index}" value="${original_price}" required />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <x-input type="text" name="main_jumlah_diminta[]" label="jumlah diminta" class="commas-form" value="${sale_order_general_detail.amount}" id="main-item-quantityRequested-${row_index}-${purchase_order_general_detail_item_index}" required readonly helpers="${unit.name}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-1 d-flex align-self-center">
                                            <div class="form-group">
                                                <x-button color="info" icon="eye" fontawesome size="sm" id="sale-order-generalDetail-btnmodal-${row_index}-${purchase_order_general_detail_item_index}" dataToggle="modal" dataTarget="#modalsale-order-generalDetail-modal-${row_index}-${purchase_order_general_detail_item_index}"/>
                                                <x-button type="" color="danger" icon="trash" fontawesome size="sm" id="sale-order-generalDetail-delete-${row_index}-${purchase_order_general_detail_item_index}"/>
                                                <x-modal title="Detail sale order item" id="modalsale-order-generalDetail-modal-${row_index}-${purchase_order_general_detail_item_index}" headerColor="info" modalSize="1000">
                                                    <x-slot name="modal_body">
                                                        <x-table id="">
                                                            ...
                                                            <x-slot name="table_body">
                                                                <tr>
                                                                    <td>${item_value} - ${sale_order_general_detail.unit?.name}</td>
                                                                    <td>${sale_order_general_detail.amount}</td>
                                                                    <td>
                                                                        <x-button color="info" icon="file" fontawesome size="sm" link="{{ url('storage/') }}/${sale_order_general_detail.file}" target="blank" />
                                                                    </td>
                                                                </tr>
                                                            </x-slot>
                                                        </x-table>
                                ...
                                $(`#sale-order-general-detail-list-${row_index}`).append(html);

                                $(`#sale-order-generalDetail-btnmodal-${row_index}-${purchase_order_general_detail_item_index}`).click(function(e) {
                                    e.preventDefault();
                                });

                                $(`#sale-order-generalDetail-delete-${row_index}-${purchase_order_general_detail_item_index}`).click(function(e) {
                                    e.preventDefault();
                                ...
                                $(`#main-item-quantity-${row_index}-${purchase_order_general_detail_item_index}`).data('testQty', sale_order_general_detail.amount);
                            ...
                            <x-card-data-table id="Rangkuman">
                                <x-slot name="table_content">
                                    ...
                                    <div class="mb-20 mt-20">
                                        <h4>sale order resume</h4>
                                        <x-table id="resume-sale-order-general">
                                            <x-slot name="table_head">
                                                <th>#</th>
                ...
                const calculateResumeData = () => {
                    ...
                    const calculateMain = () => {
                        ...
                        $('#resume-sale-order-general tbody').html('');
                        MainDataCalculate.map((main_data, main_data_index) => {
                            ...
                            main_data.purchase_order_general_detail_item.map((main_data_item, main_data_item_index) => {
                                ...
                                $('#resume-sale-order-general tbody').append(html);
                        ...
                        if (isError !== 0) {
                            ...
                            let values = {
                                ...
                                main: MainDataCalculate.map((main, main_index) => {
                                    return {
                                        "sale_order_id": main.sale_order_id,
                                        ...
                                        "purchase_order_general_detail_items": main.purchase_order_general_detail_item.map((main_data_item, main_data_index) => {
                                            return {
                                                ...
                                                "sale_order_general_detail_id": main_data_item.sale_order_general_detail_id,
