                    ...
                    <td style="padding: 0px">
                        <table style="border-collapse: collapse; border: none; padding: 0px">
                            <tr>
                                ...
                                <td style="text-align: right; padding-right: 5px">{{ floatDotFormat($model->sub_total_main + $model->sub_total_additional) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: none; text-align: right; padding-right: 5px">{{ floatDotFormat($model->total_tax_main + $model->total_tax_additional) }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
