                            ...
                            <ul style="padding-left: 10px">
                                <li>
                                    @if ($model->bank_internal->logo)
                                        <img src="{{ public_path() }}/storage/{{ $model->bank_internal->logo }}" alt="" height="25px">
                                    @else
                                        <p class="my-0">{{ $model->bank_internal->nama_bank }}</p>
                                    @endif
                                    <p class="my-0">No. Rekening : {{ $model->bank_internal->no_rekening }}</p>
                                    <p class="my-0">Atas Nama : {{ $model->bank_internal->on_behalf_of }}</p>
                                </li>
                            </ul>
