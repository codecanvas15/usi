...
@php
    $main = 'lease';
    $menu = 'import biaya dibayar dimuka';
@endphp
...
@section('content')
    <x-card-data-table title="{{ $menu }}">
        <x-slot name="table_content">
            ...
            <form action="{{ route('admin.lease.process-import') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        <div class="form-group">
                            ...
                            <x-button type="button" color="info" icon="download" label="import format" link="{{ route('admin.lease.import-forma') }}" />
                        </div>
                    </div>
                </div>
            </form>
