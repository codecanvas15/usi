...
@section('content')
    @can("create $main")
        <form action="{{ route('admin.employee.store.step3', ['employee_id' => $model->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <x-card-data-table>
                    ...
                    let html = `
                        <div class="border-top border-primary pt-20" id="work-experience-item-${index}">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input class="datepicker-input" name="to[]" label="dari" :value="localDate(old('to'))" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input class="datepicker-input" name="from[]" label="sampai" :value="localDate(old('from'))" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="name[]" label="nama perusahaan" :value="old('name')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="phone[]" label="telepon" :value="old('phone')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="employee_count[]" label="jumlah karyawan" :value="old('employee_count')" required />

                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="type[]" label="jenis perusahaan" :value="old('type')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="position[]" label="jabatan" :value="old('position')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="beginning_position[]" label="posisi awal" :value="old('beginning_position')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="end_position[]" label="posisi akhir" :value="old('end_position')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-input type="text" name="supervisor[]" label="atasan" :value="old('supervisor')" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <x-text-area name="reason_for_leaving[]" label="alasan berhenti" :value="old('reason_for_leaving')" required />
                                    </div>
                                </div>
