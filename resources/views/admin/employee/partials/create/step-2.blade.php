...
@section('content')
    @can("create $main")
        <form action="{{ route('admin.employee.store.step2', ['employee_id' => $model->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <x-card-data-table>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <x-input name="reason_for_choosing_the_major" label="alasan memilih jurusan" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <x-input name="thesis_topic" label="judul skripsi" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <x-input name="reason_for_not_passing" label="alasan tidak lulus" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const handleSpecialEducation = () => {
                let employeeSpecialEducationIndex = 0;
