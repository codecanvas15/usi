...
@section('content')
    ...
    <form action="{{ route("guest.$main.update.step1", $model) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <x-card-data-table title="{{ 'edit ' . $main }}">
            ...
            <x-slot name="table_content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-input name="name" label="Nama" value="{{ old('name') ?? $model->name }}" required="required" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-input name="parents_residence_address" label="Alamat Tinggal Orangtua (jika berbeda dengan Anda)" value="{{ old('parents_residence_address') ?? $model->parents_address }}" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-input name="parents_phone_number" label="Nomor Hp Ortu" value="{{ old('parents_phone_number ') ?? $model->parents_phone_number }}" required="required" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row border-top border-primary mt-20 pt-20">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-gorup">
                            <x-input class="datepicker-input" name="marriage_date" label="Tanggal pernikahan" :value="localDate(old('marriage_date') ?? $model->marriage_date)" />
                        </div>
                    </div>
                </div>
            ...
            'end_contract' => 'selesai kontrak',
                ...
                <div class="row mt-20 pt-20 border-top border-primary">
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-input name="leave" helpers="jarah cuti per tahun" label="jatah cuti" :value="old('leave') ?? $model->leave" required />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row mt-20 pt-20 border-top border-primary">
                    <div class="col-md-3">
                        <div class="form-group">
                            <x-select name="staff_type" label="staff type" required>
                                <option value="">-- pilih staff type --</option>
                                @foreach (\App\Enums\EmployeeTypeEnum::cases() as $item)
                                    <option value="{{ $item['name'] }}" @if (old('staff_type') == $item['name'] or $model->staff_type == $item['name']) selected @endif>{{ $item['name'] }}</option>
                                @endforeach
                            </x-select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <x-select name="religion" label="agama" required>
                                ...
                                @foreach (\App\Enums\ReligionEnum::cases() as $item)
                                    <option value="{{ $item['name'] }}" @if (old('religion') == $item['name'] or $model->religion == $item['name']) selected @endif>{{ $item['value'] }}</option>
                                @endforeach
                            </x-select>
                        </div>
                    </div>
